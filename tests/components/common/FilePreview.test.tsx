...
describe('FilePreview', () => {
  ...
  it('deve renderizar preview de imagem quando mediaType é image e objectUrl está disponível', async () => {
    ...
    render(<FilePreview attachmentId="123" filename="test.png" size={1024} mediaType="image" />);
  ...
  it('deve renderizar ícone para tipos não-imagem', () => {
    ...
    render(<FilePreview attachmentId="123" filename="document.pdf" size={2048} mediaType="pdf" />);
