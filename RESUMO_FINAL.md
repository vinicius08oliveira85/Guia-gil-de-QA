...
- ✅ `npm run setup:figma` - Verificar setup
...
- **Token Figma**: Configurado no arquivo `.env`
- **File Key**: Configurado no arquivo `.env`
- **URL Figma**: Configurada no Storybook
