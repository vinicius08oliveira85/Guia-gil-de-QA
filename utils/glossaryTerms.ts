export interface GlossaryTerm {
  term: string;
  definition: string;
  category: 'Geral' | 'Testes' | 'Metodologias' | 'Ferramentas' | 'Métricas' | 'Processos' | 'Técnicas' | 'Padrões';
  relatedTerms?: string[];
}
...
export const glossaryTerms: GlossaryTerm[] = [
  // GERAL
  {
    ...
    definition: 'Garantia de Qualidade - Processo sistemático de garantir que produtos e serviços atendam aos requisitos de qualidade especificados.',
    category: 'Geral',
    relatedTerms: ['QC', 'Testes', 'Controle de Qualidade']
  },
  {
    term: 'QC (Quality Control)',
    definition: 'Controle de Qualidade - Processo de inspeção e teste de produtos para identificar defeitos antes da liberação.',
    category: 'Geral',
  ...
  {
    term: 'Issue',
    definition: 'Problema identificado durante o desenvolvimento ou uso do software que precisa ser resolvido.',
    category: 'Geral',
    relatedTerms: ['Bug', 'Defeito', 'Ticket']
  },
  {
    term: 'Ticket',
    definition: 'Registro formal de um problema, solicitação ou tarefa no sistema de gerenciamento.',
    category: 'Geral',
  ...
  {
    term: 'Teste Unitário',
    definition: 'Teste de unidades individuais de código (funções, métodos) isoladamente para verificar comportamento correto.',
    category: 'Testes',
    relatedTerms: ['Teste de Integração', 'TDD', 'Cobertura de Código']
  },
  {
    term: 'Teste de Integração',
    definition: 'Teste que verifica a interação entre diferentes módulos ou componentes do sistema.',
    category: 'Testes',
    relatedTerms: ['Teste Unitário', 'Teste de Sistema', 'API Testing']
  },
  {
    term: 'Teste de Sistema',
    definition: 'Teste do sistema completo e integrado para verificar se atende aos requisitos especificados.',
    category: 'Testes',
    relatedTerms: ['Teste de Integração', 'Teste End-to-End', 'Teste de Aceitação']
  },
  {
    term: 'Teste End-to-End (E2E)',
    definition: 'Teste que valida o fluxo completo de uma funcionalidade do início ao fim, simulando uso real.',
    category: 'Testes',
    relatedTerms: ['Teste de Sistema', 'Teste de Aceitação', 'Automação']
  },
  {
    term: 'Teste de Aceitação',
    definition: 'Teste realizado para determinar se o sistema atende aos critérios de aceitação do usuário.',
    category: 'Testes',
    relatedTerms: ['UAT', 'Teste de Sistema', 'Critérios de Aceitação']
  },
  {
    term: 'UAT (User Acceptance Testing)',
    definition: 'Teste de Aceitação do Usuário - Teste realizado pelos usuários finais para validar se o sistema atende às necessidades de negócio.',
    category: 'Testes',
    relatedTerms: ['Teste de Aceitação', 'Beta Testing']
  },
  {
    term: 'Teste de Regressão',
    definition: 'Teste que verifica se funcionalidades existentes ainda funcionam após mudanças no código.',
    category: 'Testes',
    relatedTerms: ['Automação', 'Smoke Test', 'Sanity Test']
  },
  {
    term: 'Teste de Fumaça (Smoke Test)',
    definition: 'Teste rápido e superficial para verificar se as funcionalidades básicas do sistema estão funcionando.',
    category: 'Testes',
    relatedTerms: ['Sanity Test', 'Teste de Regressão']
  },
  {
    term: 'Sanity Test',
    definition: 'Teste rápido para verificar se uma funcionalidade específica funciona após uma mudança.',
    category: 'Testes',
    relatedTerms: ['Smoke Test', 'Teste de Regressão']
  },
  {
    term: 'Teste de Performance',
    definition: 'Teste que avalia o desempenho do sistema sob diferentes condições de carga e volume.',
    category: 'Testes',
    relatedTerms: ['Load Testing', 'Stress Testing', 'Volume Testing']
  },
  {
    term: 'Load Testing',
    definition: 'Teste de carga - Avalia o comportamento do sistema sob carga esperada de uso normal.',
    category: 'Testes',
    relatedTerms: ['Stress Testing', 'Performance Testing']
  },
  {
    term: 'Stress Testing',
    definition: 'Teste de estresse - Avalia o comportamento do sistema sob carga extrema além da capacidade normal.',
    category: 'Testes',
    relatedTerms: ['Load Testing', 'Volume Testing']
  },
  {
    term: 'Teste de Segurança',
    definition: 'Teste que identifica vulnerabilidades e garante que o sistema está protegido contra ameaças.',
    category: 'Testes',
    relatedTerms: ['Penetration Testing', 'Vulnerabilidade', 'OWASP']
  },
  {
    term: 'Penetration Testing',
    definition: 'Teste de penetração - Simulação de ataques para identificar vulnerabilidades de segurança.',
    category: 'Testes',
    relatedTerms: ['Teste de Segurança', 'Ethical Hacking']
  },
  {
    term: 'Teste Exploratório',
    definition: 'Abordagem de teste que combina aprendizado, design e execução de testes simultaneamente.',
    category: 'Testes',
  ...
  {
    term: 'A11y',
    definition: 'Abreviação de "Accessibility" (A + 11 letras + y) - Acessibilidade em interfaces digitais.',
    category: 'Testes',
    relatedTerms: ['WCAG', 'Teste de Acessibilidade']
  },
  {
    term: 'WCAG',
    definition: 'Web Content Accessibility Guidelines - Diretrizes internacionais para acessibilidade web.',
    category: 'Padrões',
    relatedTerms: ['A11y', 'Teste de Acessibilidade']
  },
  {
    term: 'Teste de Compatibilidade',
    definition: 'Teste que verifica se o software funciona em diferentes ambientes, navegadores ou dispositivos.',
    category: 'Testes',
  ...
  {
    term: 'Ágil',
    definition: 'Metodologia de desenvolvimento iterativa e incremental que valoriza colaboração e resposta a mudanças.',
    category: 'Metodologias',
    relatedTerms: ['Scrum', 'Kanban', 'Sprint']
  },
  {
    term: 'Scrum',
    definition: 'Framework ágil para gerenciamento de projetos com sprints, cerimônias e papéis definidos.',
    category: 'Metodologias',
    relatedTerms: ['Sprint', 'Product Owner', 'Scrum Master']
  },
  {
    term: 'Sprint',
    definition: 'Período de tempo fixo (geralmente 1-4 semanas) para desenvolver um incremento de produto.',
    category: 'Metodologias',
  ...
  },
  {
    ...
    definition: 'Trabalho em Progresso - Limite de itens que podem estar em execução simultaneamente.',
    category: 'Metodologias',
    relatedTerms: ['Kanban', 'Fluxo']
  },
  {
    term: 'BDD (Behavior-Driven Development)',
    definition: 'Desenvolvimento Orientado a Comportamento - Abordagem que usa linguagem natural para descrever comportamentos.',
    category: 'Metodologias',
    relatedTerms: ['TDD', 'Gherkin', 'Given-When-Then']
  },
  {
    term: 'TDD (Test-Driven Development)',
    definition: 'Desenvolvimento Orientado a Testes - Prática de escrever testes antes do código de produção.',
    category: 'Metodologias',
    relatedTerms: ['BDD', 'Teste Unitário', 'Refatoração']
  },
  {
    term: 'Gherkin',
    definition: 'Linguagem de domínio específica usada para escrever cenários de teste em formato legível.',
    category: 'Metodologias',
    relatedTerms: ['BDD', 'Given-When-Then', 'Cucumber']
  },
  {
    term: 'Given-When-Then',
    definition: 'Estrutura para escrever cenários de teste: Dado (contexto), Quando (ação), Então (resultado esperado).',
    category: 'Metodologias',
  ...
  {
    term: 'DevOps',
    definition: 'Cultura e conjunto de práticas que unifica desenvolvimento e operações para acelerar entrega.',
    category: 'Metodologias',
    relatedTerms: ['CI/CD', 'Automação', 'Infraestrutura como Código']
  },
  {
    term: 'CI/CD',
    definition: 'Continuous Integration / Continuous Deployment - Integração e deploy contínuos automatizados.',
    category: 'Metodologias',
  ...
  {
    term: 'Selenium',
    definition: 'Framework de automação de testes para aplicações web que suporta múltiplos navegadores.',
    category: 'Ferramentas',
    relatedTerms: ['WebDriver', 'Automação Web']
  },
  {
    term: 'WebDriver',
    definition: 'Protocolo e API para controlar navegadores programaticamente em testes automatizados.',
    category: 'Ferramentas',
    relatedTerms: ['Selenium', 'Automação']
  },
  {
    term: 'Cypress',
    definition: 'Ferramenta moderna de teste end-to-end para aplicações web com execução em tempo real.',
    category: 'Ferramentas',
    relatedTerms: ['E2E Testing', 'Automação']
  },
  {
    term: 'Playwright',
    definition: 'Framework de automação de testes que suporta múltiplos navegadores com uma única API.',
    category: 'Ferramentas',
    relatedTerms: ['Automação', 'Cross-Browser']
  },
  {
    term: 'Jest',
    definition: 'Framework de testes JavaScript focado em simplicidade e suporte a grandes projetos.',
    category: 'Ferramentas',
  ...
  {
    term: 'Jira',
    definition: 'Ferramenta de gerenciamento de projetos e rastreamento de issues amplamente usada.',
    category: 'Ferramentas',
  ...
  {
    term: 'Appium',
    definition: 'Ferramenta de automação de testes para aplicativos móveis nativos, híbridos e web.',
    category: 'Ferramentas',
  ...
  // MÉTRICAS
  {
    ...
    definition: 'Percentual de código executado durante os testes, indicando quanto do código foi testado.',
    category: 'Métricas',
  ...
  },
  {
    ...
    definition: 'Cobertura de ramos - Percentual de ramos condicionais (if/else) executados nos testes.',
    category: 'Métricas',
    relatedTerms: ['Cobertura de Código', 'Line Coverage']
  },
  {
    term: 'Line Coverage',
    definition: 'Cobertura de linhas - Percentual de linhas de código executadas durante os testes.',
    category: 'Métricas',
    relatedTerms: ['Cobertura de Código', 'Branch Coverage']
  },
  {
    term: 'Taxa de Defeitos',
    definition: 'Número de defeitos encontrados por unidade de medida (por funcionalidade, por hora, etc.).',
    category: 'Métricas',
    relatedTerms: ['Densidade de Defeitos', 'Métricas de Qualidade']
  },
  {
    term: 'Densidade de Defeitos',
    definition: 'Número de defeitos por tamanho do software (linhas de código, pontos de função, etc.).',
    category: 'Métricas',
  ...
  },
  {
    ...
    definition: 'Tempo Médio Para Reparo - Tempo médio necessário para reparar um sistema após falha.',
    category: 'Métricas',
  ...
  {
    term: 'Escape Rate',
    definition: 'Taxa de escape - Percentual de defeitos que escaparam dos testes e foram para produção.',
    category: 'Métricas',
  ...
  {
    term: 'Plano de Teste',
    definition: 'Documento que descreve escopo, abordagem, recursos e cronograma das atividades de teste.',
    category: 'Processos',
    relatedTerms: ['Estratégia de Teste', 'Documentação']
  },
  {
    term: 'Estratégia de Teste',
    definition: 'Abordagem geral para testar um sistema, incluindo tipos de teste e níveis de teste.',
    category: 'Processos',
    relatedTerms: ['Plano de Teste', 'Abordagem']
  },
  {
    term: 'Caso de Teste',
    definition: 'Conjunto de condições, ações e resultados esperados para verificar uma funcionalidade específica.',
    category: 'Processos',
  ...
  {
    term: 'Gate',
    definition: 'Ponto de decisão no processo onde critérios específicos devem ser atendidos para prosseguir.',
    category: 'Processos',
  ...
  {
    term: 'Bug Report',
    definition: 'Documento que descreve um defeito encontrado, incluindo passos para reproduzir e resultado esperado.',
    category: 'Processos',
  ...
  },
  {
    ...
    definition: 'Teste de regressão - Verificação de que funcionalidades existentes ainda funcionam após mudanças.',
    category: 'Processos',
    relatedTerms: ['Teste de Regressão', 'Automação']
  },
  {
    term: 'Verificação',
    definition: 'Processo de verificar se o produto foi construído corretamente (atende especificações).',
    category: 'Processos',
    relatedTerms: ['Validação', 'Conformidade']
  },
  {
    term: 'Validação',
    definition: 'Processo de validar se o produto correto foi construído (atende necessidades do usuário).',
    category: 'Processos',
  ...
  // TÉCNICAS
  {
    ...
    definition: 'Técnica de teste que divide dados de entrada em classes equivalentes para reduzir casos de teste.',
    category: 'Técnicas',
    relatedTerms: ['Boundary Value Analysis', 'Técnicas de Teste']
  },
  {
    term: 'Boundary Value Analysis',
    definition: 'Análise de Valores Limite - Técnica que testa valores nos limites das classes de equivalência.',
    category: 'Técnicas',
    relatedTerms: ['Equivalence Partitioning', 'Técnicas de Teste']
  },
  {
    term: 'Decision Table',
    definition: 'Tabela de Decisão - Técnica que organiza combinações de condições e ações em formato tabular.',
    category: 'Técnicas',
  ...
  },
  {
    ...
    definition: 'Técnica de teste baseada em casos de uso que descrevem interações entre atores e sistema.',
    category: 'Técnicas',
    relatedTerms: ['Cenários', 'Casos de Uso']
  },
  {
    term: 'Pairwise Testing',
    definition: 'Técnica que testa todas as combinações de pares de parâmetros para reduzir casos de teste.',
    category: 'Técnicas',
  ...
  },
  {
    ...
    definition: 'Técnica que modifica o código (mutantes) para verificar se os testes detectam as mudanças.',
    category: 'Técnicas',
    relatedTerms: ['Qualidade de Teste', 'Cobertura']
  },
  {
    term: 'Property-Based Testing',
    definition: 'Técnica que testa propriedades do código com múltiplas entradas geradas automaticamente.',
    category: 'Técnicas',
    relatedTerms: ['Teste Automatizado', 'Geração de Dados']
  },
  {
    term: 'Mock',
    definition: 'Objeto simulado que imita comportamento de dependências para isolar unidades de teste.',
    category: 'Técnicas',
    relatedTerms: ['Stub', 'Fake', 'Test Doubles']
  },
  {
    term: 'Stub',
    definition: 'Implementação simplificada de uma dependência que retorna respostas pré-definidas.',
    category: 'Técnicas',
  ...
  {
    term: 'Test Doubles',
    definition: 'Termo genérico para objetos que substituem dependências em testes (Mock, Stub, Fake, etc.).',
    category: 'Técnicas',
  ...
  {
    term: 'ISTQB',
    definition: 'International Software Testing Qualifications Board - Organização que define padrões e certificações de teste.',
    category: 'Padrões',
    relatedTerms: ['Certificação', 'Padrões de Teste']
  },
  {
    term: 'ISO 25010',
    definition: 'Padrão ISO que define modelo de qualidade de software com características e subcaracterísticas.',
    category: 'Padrões',
  ...
  {
    term: 'OWASP',
    definition: 'Open Web Application Security Project - Organização que fornece padrões e ferramentas de segurança.',
    category: 'Padrões',
  ...
  {
    term: 'PCI DSS',
    definition: 'Payment Card Industry Data Security Standard - Padrão de segurança para dados de cartão de crédito.',
    category: 'Padrões',
