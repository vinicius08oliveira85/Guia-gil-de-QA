...
export const DEV_TASKS_COPY = {
  ...
  subtitle:
    'Acompanhe o backlog e use a IA para obter guias de implementação, sugestões de ferramentas e passos alinhados à stack do projeto.',
  ...
  listSectionDesc:
    'Todas as tarefas do projeto com filtros e ações em lote. Abra uma tarefa para ver o guia de implementação.',
} as const;
