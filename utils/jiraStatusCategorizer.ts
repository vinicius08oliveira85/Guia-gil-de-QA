 ...
 */
export type JiraStatusCategory = 'Concluído' | 'Validado' | 'Em Andamento' | 'Pendente' | 'Bloqueado' | 'Outros';
 ...
 */
export const groupTasksByStatusCategory = (tasks: JiraTask[]): Map<JiraStatusCategory, JiraTask[]> => {
    const grouped = new Map<JiraStatusCategory, JiraTask[]>();
    
    // Inicializar todas as categorias
    const categories: JiraStatusCategory[] = ['Concluído', 'Validado', 'Em Andamento', 'Pendente', 'Bloqueado', 'Outros'];
 ...
 */
export const countTasksByStatusCategory = (tasks: JiraTask[]): Record<JiraStatusCategory, number> => {
