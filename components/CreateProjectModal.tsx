...
export const CreateProjectModal: React.FC<CreateProjectModalProps> = ({
    ...
    const loadJiraProjects = useCallback(async (useCache: boolean = true) => {
        try {
    ...
    const handleImportJiraProject = useCallback(async () => {
        ...
        try {
            ...
            const importedProject = await importJiraProject(jiraConfig, selectedJiraProjectKey, (current, total) => {
    ...
    }, [selectedJiraProjectKey, importProject, handleClose, onProjectImported, handleError, handleSuccess]);
            ...
            <Modal
                ...
                footer={
                    <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
                        <button type="button" onClick={handleClose} className="btn btn-ghost rounded-full w-full sm:w-auto">
                            Cancelar
                        </button>
                        {!showJiraImport && (
                            <button
                ...
                <div className="space-y-4">
                    {!showTemplates && !showJiraImport ? (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-sm text-base-content/70">Recomendado para começar mais rápido com um checklist inicial.</p>
                                        </div>
                                    </div>
                                </button>
                                <button
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-sm text-base-content/70">Importe um projeto existente do Jira com todas as tarefas e casos de teste.</p>
                                        </div>
                                    </div>
                                </button>
                                <button
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-sm text-base-content/70">Importe um projeto a partir de um arquivo JSON exportado anteriormente.</p>
                                        </div>
                                    </div>
                                </button>
                            </div>
                                ...
                                <div className="alert alert-warning">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-sm opacity-80">Configure a integração para listar e importar projetos.</p>
                                        </div>
                                        <button
                                            type="button"
                                            className="btn btn-primary rounded-full w-full sm:w-auto"
                            ...
                            <Card className="p-4 sm:p-6" hoverable={false}>
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                        <label className="block text-sm font-medium text-base-content">Selecione o projeto para importar:</label>
                                        <button
                                        ...
                                        >
                                            <RefreshCw className={`h-3 w-3 ${isLoadingJiraProjects ? 'animate-spin' : ''}`} aria-hidden />
                                            Atualizar
                                        </button>
                                    </div>
                                    {jiraConfigStatus !== 'configured' ? (
                                        <div className="text-center py-8">
                                            <p className="text-base-content/70 text-sm">Configure o Jira para visualizar a lista de projetos.</p>
                                        </div>
                                    ) : isLoadingJiraProjects ? (
                                        <div className="flex justify-center py-8">
                                            <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-primary" aria-label="Carregando projetos do Jira" />
                                        </div>
                                            ...
                                            {isImportingJira && importProgress && (
                                                <div className="w-full bg-base-200 rounded-full h-2.5" aria-label="Progresso de importação">
                                                    <div
                                                        ...
                                                        style={{ width: importProgress.total ? `${Math.min((importProgress.current / importProgress.total) * 100, 100)}%` : '50%' }}
                                                    />
                                                </div>
                                            )}
                                        </>
                                        ...
                                        <div className="text-center py-8">
                                            <p className="text-base-content/70 text-sm">Nenhum projeto encontrado. Verifique suas permissões no Jira.</p>
                                        </div>
                                    )}
                                </div>
                            </Card>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-4">
                                <label className="form-control w-full">
                                    <div className="label"><span className="label-text">Nome do Projeto</span></div>
                                    <input
