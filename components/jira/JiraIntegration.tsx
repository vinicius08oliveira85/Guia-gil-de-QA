    ...
    <Card>
      ...
      {!isConnected ? (
        <div className="space-y-4">
          ...
          <button onClick={() => setShowConfigModal(true)} className="btn btn-primary w-full">
            🔗 Configurar Conexão
          </button>
        </div>
      ) : (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-text-secondary text-xs">URL: {config.url}</p>
            </div>
              ...
              {isImporting && (
                <div className="mt-2 p-4 bg-surface border border-surface-border rounded-lg">
                  ...
                  <div className="space-y-1 text-xs text-text-secondary">
                    ...
                    <p className="text-accent">💡 Não feche esta página durante a importação!</p>
                  </div>
                </div>
              )}
            </div>
