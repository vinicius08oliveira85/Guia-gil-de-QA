          ...
          {filteredTerms.length > 0 ? (
            filteredTerms.map((term, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${getCategoryGradient(term.category)} opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none`}
                />
      ...
      <Modal
        ...
        footer={
          <div className="flex justify-end">
            <button type="button" onClick={() => setSelectedTerm(null)} className="btn btn-primary">
              Fechar
            </button>
          </div>
        }
