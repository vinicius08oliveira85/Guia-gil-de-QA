...
export const ShiftLeftCard: React.FC<{ project: Project; }> = ({ project }) => {
    ...
    const hasRecommendations = project.shiftLeftAnalysis && Object.keys(recommendationsByPhase).length > 0;
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            {shiftLeftBenefits.length > 3 && (
                                <li className="text-xs text-text-secondary">+{shiftLeftBenefits.length - 3} mais...</li>
                            )}
                        </ul>
                    </div>
                     <div>
                        ...
                        {project.shiftLeftAnalysis ? (
                            <div className="space-y-2">
                                ...
                                {Object.keys(recommendationsByPhase).length > 2 && (
                                    <p className="text-xs text-accent cursor-pointer" onClick={() => setShowDetails(true)}>
