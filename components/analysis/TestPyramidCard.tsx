            ...
            <div className="w-full">
              {pyramidLevels.map((level, index) => {
                ...
                return (
                  ...
                  >
                    {level}{' '}
                    {analysisMap?.get(level)?.effort && `(${analysisMap.get(level)?.effort})`}
                  </div>
                );
              })}
            </div>
          ...
          <div>
            ...
            {project.testPyramidAnalysis ? (
              <div className="space-y-2">
                ...
                <p
                  className="text-xs text-accent cursor-pointer mt-2"
                  onClick={() => setShowDetails(true)}
                >
