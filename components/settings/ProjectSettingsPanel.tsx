    ...
    return (
        <div className="space-y-6">
            <div className="rounded-2xl border border-base-300 bg-base-100 p-6 shadow-sm">
                <h2 className="text-lg font-bold text-base-content mb-1">Backlog Prioritization (Jira)</h2>
                <p className="text-sm text-base-content/70 mb-4">
                    Se os valores de Impact, Confidence, Ease e Score não aparecerem após &quot;Atualizar do Jira&quot;, informe os IDs dos custom fields do seu Jira (ex.: customfield_10050). Você pode obter os IDs em GET /rest/api/3/field ou na seção &quot;Campos customizados do Jira&quot; no card da tarefa.
                </p>
