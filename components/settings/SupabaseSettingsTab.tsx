    ...
    return [
      {
        ...
        configured: true,
        description:
          'Configurada no Vercel (backend). URL do projeto Supabase. Não verificável no navegador.',
        required: true,
      },
      {
        ...
        configured: true,
        description:
          'Configurada no Vercel (backend). Chave de serviço do Supabase. Não verificável no navegador.',
        required: true,
      },
    ];
  }, []);
        ...
        <div className="space-y-6">
          {supabaseAvailable ? (
            ...
            <>
              <div>
                <p className="text-base-content/70 text-sm mb-4 leading-relaxed">
                  Supabase não está configurado. Configure as variáveis abaixo para habilitar o
