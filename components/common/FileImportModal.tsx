          ...
          switch (selectedType) {
            ...
            case 'test-cases':
              ...
              if (file.name.endsWith('.xlsx') || file.name.endsWith('.xls')) {
                ...
                throw new Error(
                  'Formato inválido. Use um arquivo Excel (.xlsx, .xls) para importar casos de teste.'
                );
              }
              ...
              if (result.success && result.data) {
                if (result.data instanceof Array) {
                  ...
                  if (onImportTasks && result.data.length > 0 && 'type' in result.data[0]) {
                    ...
                    handleSuccess(
                      `${result.data.length} caso(s) de teste importado(s) com sucesso!`
                    );
                  }
      ...
      <Modal isOpen={isOpen} onClose={onClose} title="Importar Arquivo" size="md">
        <div className="p-4 space-y-4">
          ...
          <div className="text-sm text-text-secondary">
            ...
            {selectedType === 'auto' && <p>O tipo de arquivo será detectado automaticamente.</p>}
          </div>
