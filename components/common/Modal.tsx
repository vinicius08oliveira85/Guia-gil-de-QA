    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 p-6 border-b border-base-200 flex-shrink-0">
          <div
            id="modal-title"
            className="min-w-0 flex-1 pr-8 text-lg sm:text-xl font-semibold text-base-content"
          >
            {title}
          </div>
        </div>
        ...
        {/* Footer */}
        {footer && (
          <div className="p-4 border-t border-base-200 bg-base-100/50 flex-shrink-0">{footer}</div>
        )}
      </div>
    </div>
  );
