  ...
  return (
    <div className={cn(appPanelClass, 'p-3')}>
      <div className="flex flex-wrap items-center gap-2">
        <div className="app-element-typography flex items-center gap-2 text-sm text-base-content/72">
          <svg
          ...
          {filterChips.map(chip => {
            ...
            const getVariant = (
              ...
              if (key.includes('priority') || key.includes('severity')) {
                if (chip.value.includes('Crítica') || chip.value.includes('Crítico'))
                  return 'error';
              ...
              if (key.includes('status')) {
                ...
                if (chip.value.includes('Passed') || chip.value.includes('Success'))
                  return 'success';
                return 'info';
              }
              return 'default';
