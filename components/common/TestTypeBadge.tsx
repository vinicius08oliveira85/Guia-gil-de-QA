...
const testTypeIconMapNormalized: Record<
  string,
...
export const TestTypeBadge = React.memo<TestTypeBadgeProps>(
  ({
    ...
    const pillVariantClasses =
      variantStyle === 'pastel' ? pillVariantClassesPastel : pillVariantClassesSolid;
    const pillIconClasses =
      variantStyle === 'pastel' ? pillIconClassesPastel : pillIconClassesSolid;
    ...
    return (
      ...
      >
        <TestTypeIcon
          className={cn(iconSizes[size], pillIconClasses[variant])}
          aria-hidden="true"
        />
