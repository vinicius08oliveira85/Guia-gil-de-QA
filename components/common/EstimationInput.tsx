    ...
    <div className="space-y-6">
      ...
      <div className="bg-base-200/50 dark:bg-base-300/30 border border-base-300 rounded-xl p-5 relative overflow-hidden">
        <div className="flex justify-between items-start mb-3 relative z-10">
          <div>
            <span className="text-xs font-bold text-base-content uppercase tracking-wide">
              Sugestão Automática
            </span>
            <div className="flex items-center gap-1.5 mt-1">
              <span className="text-[10px] text-base-content/60 bg-base-300/50 dark:bg-base-200 px-1.5 py-0.5 rounded">
        ...
        <div
          className="absolute -right-2 -bottom-2 opacity-[0.05] dark:opacity-10 pointer-events-none"
          aria-hidden
        >
