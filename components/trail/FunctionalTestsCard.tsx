...
export const FunctionalTestsCard: React.FC<FunctionalTestsCardProps> = ({
    ...
    return (
        <section className="min-w-0 space-y-5 rounded-[var(--rounded-box)] border border-base-300 bg-base-100 p-5 shadow-sm sm:p-6">
            <header>
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-base-content/60">Bloco 3</p>
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4 min-w-0">
                <div className="rounded-2xl border border-base-300 bg-base-200 p-4 text-center">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-base-content/60">Casos totais</p>
                    <p className="mt-2 text-2xl font-semibold text-base-content">{totalTestCases}</p>
                </div>
                <div className="rounded-2xl border border-base-300 bg-base-200 p-4 text-center">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-base-content/60">Executados</p>
                    <p className="mt-2 text-2xl font-semibold text-primary">{executedTestCases}</p>
                    <p className="mt-1 break-words text-xs text-base-content/70">{formatPercent(executionRate)} executados</p>
                </div>
                <div className="rounded-2xl border border-base-300 bg-base-200 p-4 text-center">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-base-content/60">Falhas</p>
                ...
                <div className="rounded-2xl border border-base-300 bg-base-200 p-4 text-center">
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-base-content/60">Pendentes</p>
            ...
            <div className="min-w-0 rounded-2xl border border-base-300 bg-base-200 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-base-content/60">Taxa de aprovação</p>
                <div className="mt-3">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="min-w-0 rounded-2xl border border-base-300 bg-base-200 p-4">
                    <p className="mb-2 text-xs font-semibold uppercase tracking-[0.35em] text-base-content/60">Cobertura pendente</p>
                    {tasksWithoutTests.length === 0 ? (
                        <p className="break-words text-sm text-base-content/70">Todas as histórias possuem casos de teste.</p>
                    ) : (
                ...
                <div className="min-w-0 rounded-2xl border border-base-300 bg-base-200 p-4">
                    <p className="mb-2 text-xs font-semibold uppercase tracking-[0.35em] text-base-content/60">Falhas em atenção</p>
                    {tasksWithFailures.length === 0 ? (
                        <p className="break-words text-sm text-base-content/70">Nenhuma falha registrada nos testes executados.</p>
                    ) : (
                        <ul className="space-y-2 break-words text-sm leading-relaxed text-base-content">
