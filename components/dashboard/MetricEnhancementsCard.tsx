        ...
        <div className="space-y-4">
          ...
          <div className="p-5 bg-base-100 rounded-xl border border-base-300 hover:bg-base-200 transition-colors">
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-sm text-base-content/70">
                  Atual: {metricEnhancements.testPassRate.current}%
                </span>
                <Badge
                  variant={getTrendVariant(
                    metricEnhancements.testPassRate.current,
                    metricEnhancements.testPassRate.predicted
                  )}
                  size="sm"
            ...
            <p className="text-sm text-base-content/80 leading-relaxed">
              {metricEnhancements.testPassRate.suggestion}
            </p>
          </div>
          ...
          <div className="p-5 bg-base-100 rounded-xl border border-base-300 hover:bg-base-200 transition-colors">
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-sm text-base-content/70">
                  Atual: {metricEnhancements.bugResolution.current}
                </span>
                <Badge
                  variant={getTrendVariant(
                    metricEnhancements.bugResolution.current,
                    metricEnhancements.bugResolution.predicted
                  )}
                  size="sm"
                  className="inline-flex items-center gap-1"
                >
            ...
            <p className="text-sm text-base-content/80 leading-relaxed">
              {metricEnhancements.bugResolution.suggestion}
            </p>
          </div>
          ...
          <div className="p-5 bg-base-100 rounded-xl border border-base-300 hover:bg-base-200 transition-colors">
            <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-sm text-base-content/70">
                  Atual: {metricEnhancements.coverage.current}%
                </span>
            ...
            <p className="text-sm text-base-content/80 leading-relaxed">
              {metricEnhancements.coverage.suggestion}
            </p>
          </div>
        </div>
      </Card>
