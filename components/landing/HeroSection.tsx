    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-base-100 via-base-200 to-base-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Transforme sua gestão de qualidade com metodologias ágeis, automação inteligente e insights em tempo real.
          ...
          >
            {[
              { icon: Zap, text: 'Automação Inteligente', color: 'text-primary' },
              { icon: Target, text: 'Métricas em Tempo Real', color: 'text-secondary' },
              { icon: Sparkles, text: 'IA Integrada', color: 'text-accent' },
            ].map((feature, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
