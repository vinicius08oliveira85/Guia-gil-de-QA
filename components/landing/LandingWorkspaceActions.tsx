...
/**
 * Botões globais da home: atualizar tudo do Jira e salvar o workspace no banco local.
 */
  ...
  return (
    ...
    >
      <button
        ...
        title="Atualizar tudo do Jira (Projetos QA, Dev e Acompanhamentos)"
      >
        {isSyncingJira ? (
      ...
      <button
        ...
        disabled={busy}
        className={cn(landingNeuActionBtnClass, 'group shrink-0')}
        aria-label="Salvar todos os dados no banco local"
