...
function parseGherkinSegments(text: string): Array<{ type: 'text' | 'keyword'; value: string; keywordType?: string }> {
...
export const BddScenarioForm: React.FC<{
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4 p-5 bg-base-100 rounded-lg my-2 border border-base-300 border-l-4 border-l-primary shadow-sm">
            <div>
