...
export const TaskForm: React.FC<{
  ...
  const validateForm = (): boolean => {
    ...
    if (!taskData.title || taskData.title.trim() === '') {
      ...
      errors.title =
        'Título muito curto. Seja mais descritivo. Exemplo: "Implementar login com email"';
    }
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {taskData.type === 'Bug' && (
            <div>
              ...
              <select
                ...
                onChange={e =>
                  setTaskData({ ...taskData, severity: e.target.value as BugSeverity })
                }
                className={selectClass}
              >
      ...
      <div className="flex flex-wrap justify-end gap-2 pt-1">
        <button
          type="button"
          onClick={onCancel}
          className="btn btn-ghost btn-sm rounded-xl border border-base-300 text-base-content hover:bg-base-200"
        >
          Cancelar
        </button>
        <button
