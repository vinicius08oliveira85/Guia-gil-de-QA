        ...
        <Card>
            <div className="flex flex-col gap-4 mb-6">
                ...
                <div className="space-y-2 mb-4">
                    <label htmlFor="tasks-quick-search" className="sr-only">Buscar tarefas e casos de teste</label>
                    <div className="relative">
                        ...
                        <input
                            id="tasks-quick-search"
                            type="search"
                            value={filters.searchQuery || ''}
                            onChange={(e) => handleSearchQueryChange(e.target.value)}
                            placeholder="Buscar rapidamente por ID, título ou descrição..."
                            className="w-full pl-10 pr-28 py-2.5 bg-surface border border-surface-border rounded-lg text-sm text-text-primary placeholder-text-secondary focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent transition-all"
                            autoComplete="off"
                            inputMode="search"
                        />
                        {filters.searchQuery && (
                            <button
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1 text-xs font-semibold text-accent hover:text-white hover:bg-accent rounded-full bg-accent/10 transition-all"
                    ...
                    <div className="flex flex-wrap items-center justify-between text-xs text-text-secondary">
                        <span>
                            {filters.searchQuery
                                ? `Mostrando ${filteredTasks.length} de ${project.tasks.length} itens`
                                : `${project.tasks.length} itens disponíveis`}
                        </span>
                        {filters.searchQuery && (
                            <span className="text-accent font-semibold">Filtro de texto ativo</span>
                        )}
                    </div>
                </div>
