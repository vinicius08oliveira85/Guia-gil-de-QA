...
export const JiraTaskItem: React.FC<{
    ...
    const renderTestsSection = () => {
        ...
        return (
            <div className="space-y-3">
                {/* Sub-abas de Testes */}
                <div className="flex flex-wrap gap-1.5 p-1 bg-base-200 rounded-xl w-full md:w-fit overflow-x-auto" role="tablist" aria-label="Sub-abas de testes">
                    <button
                        type="button"
                        role="tab"
                ...
                {activeTestSubSection === 'strategy' && (
                    <div>
                        <header className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-lg font-bold text-base-content text-balance">Estratégia de Teste</h2>
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-0 order-1 w-full sm:w-auto">
                        ...
                        {onToggleFavorite && (
                            <button
                                ...
                                className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 p-1 sm:p-0.5 rounded-lg sm:rounded hover:bg-base-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 shrink-0"
                        ...
                        {hasChildren ? (
                            <button
                                ...
                                className="btn btn-ghost btn-xs flex items-center gap-1 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 sm:px-1 px-2 shrink-0 rounded-xl"
                    ...
                    <div className="flex items-center gap-2 flex-wrap flex-shrink-0 w-full sm:w-auto sm:ml-auto order-2 sm:gap-2 sm:flex-nowrap" onClick={(e) => e.stopPropagation()}>
                        ...
                        {['tarefa', 'bug', 'task'].includes(taskTypeNorm) && onGenerateAll && (
                            <button
                                ...
                                className="rounded-full px-3 py-2 sm:py-1.5 sm:px-4 min-h-[44px] sm:min-h-0 text-[10px] sm:text-xs font-bold inline-flex items-center gap-1.5 bg-primary hover:bg-brand-orange-selected-hover text-primary-content transition-colors shrink-0"
                        ...
                        <button
                            ...
                            className={`rounded-full px-3 py-2 sm:py-1.5 sm:px-4 min-h-[44px] sm:min-h-0 text-[10px] sm:text-xs font-bold border inline-flex items-center gap-1.5 shrink-0 transition-colors ${testStatusButtonVariant[taskTestStatus] ?? defaultTestStatusButtonClass}`}
                        ...
                        <button
                            ...
                            className="btn btn-ghost btn-sm btn-circle shrink-0 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 text-base-content/60 hover:text-base-content"
                                    ...
                                    <div className="flex items-center gap-1.5 flex-wrap pb-3 border-b border-base-200">
                                        ...
                                        <div className="dropdown dropdown-start">
                                            <button
                                                type="button"
                                                tabIndex={0}
                                                className="btn btn-ghost btn-sm btn-square rounded-xl min-h-[44px] min-w-[44px] sm:min-h-8 sm:min-w-8"
                                            ...
                                            {sectionTabs.map((tab) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`min-h-[44px] sm:min-h-0 px-3 py-2 text-xs rounded-xl font-medium transition-colors sm:px-3 sm:py-1.5 sm:text-sm inline-flex items-center ${isActive ? 'bg-brand-orange-selected text-white shadow-md shadow-brand-orange-selected/20 hover:bg-brand-orange-selected-hover' : 'text-base-content/70 hover:text-base-content hover:bg-base-200'}`}
