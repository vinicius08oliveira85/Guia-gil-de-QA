...
import { RequirementAIAnalysisCard } from './RequirementAIAnalysisCard';
...
export const RequirementCard: React.FC<RequirementCardProps> = ({
    ...
    return (
        <Card className={`${isRestricted ? 'opacity-75 border-2 border-warning/30' : ''}`}>
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {requirement.aiAnalysis && (
                        <Badge 
                            variant={getQualityColor(requirement.aiAnalysis.qualityScore)} 
                            size="sm"
                        >
                            IA: {requirement.aiAnalysis.qualityScore}%
                        </Badge>
                    )}
                </div>
                ...
                {!isRestricted && (
                    <div className="flex gap-2 pt-2 border-t border-surface-border">
                        {requirement.aiAnalysis && (
                            ...
                            >
                                {showAIAnalysis ? 'Ocultar' : 'Ver'} Análise IA
                            </button>
                        )}
            ...
            {/* Análise de IA */}
            {showAIAnalysis && requirement.aiAnalysis && (
                <div className="mt-4">
                    <RequirementAIAnalysisCard analysis={requirement.aiAnalysis} />
                </div>
            )}
        </Card>
    );
