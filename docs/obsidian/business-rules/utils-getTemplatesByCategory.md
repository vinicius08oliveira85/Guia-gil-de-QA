...
tag: business-rule
status: active
file_origin: utils/testCaseTemplates.ts
---

# Get Templates By Category

**Descrição:** Regra derivada da exportação `getTemplatesByCategory` em `utils/testCaseTemplates.ts`: lógica e validações implementadas no código.
