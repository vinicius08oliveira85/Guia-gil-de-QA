...
tag: business-rule
status: active
file_origin: utils/fileMetadata.ts
---

# Get File Metadata

**Descrição:** Regra derivada da exportação `getFileMetadata` em `utils/fileMetadata.ts`: lógica e validações implementadas no código.
