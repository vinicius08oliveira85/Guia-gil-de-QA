...
# Generate Shift Left Analysis

**Descrição:** Regra derivada da exportação `generateShiftLeftAnalysis` em `services/geminiService.ts`: lógica e validações implementadas no código.
