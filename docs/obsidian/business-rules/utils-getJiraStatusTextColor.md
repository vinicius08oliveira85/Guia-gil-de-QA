...
tag: business-rule
status: active
file_origin: utils/jiraStatusColors.ts
---

# Get Jira Status Text Color

**Descrição:** Regra derivada da exportação `getJiraStatusTextColor` em `utils/jiraStatusColors.ts`: lógica e validações implementadas no código.
