...
tag: business-rule
status: active
file_origin: services/jira/config.ts
---

# Test Jira Connection

**Descrição:** Regra derivada da exportação `testJiraConnection` em `services/jira/config.ts`: lógica e validações implementadas no código.
