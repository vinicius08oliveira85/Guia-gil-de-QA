...
tag: business-rule
status: active
file_origin: utils/validation.ts
---

# Project Document Schema

**Descrição:** Regra derivada da exportação `ProjectDocumentSchema` em `utils/validation.ts`: lógica e validações implementadas no código.
