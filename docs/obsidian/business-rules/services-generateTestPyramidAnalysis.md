...
# Generate Test Pyramid Analysis

**Descrição:** Regra derivada da exportação `generateTestPyramidAnalysis` em `services/geminiService.ts`: lógica e validações implementadas no código.
