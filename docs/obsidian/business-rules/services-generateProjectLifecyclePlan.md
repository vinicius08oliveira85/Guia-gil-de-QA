...
tag: business-rule
status: active
file_origin: services/geminiService.ts
---

# Generate Project Lifecycle Plan

**Descrição:** Regra derivada da exportação `generateProjectLifecyclePlan` em `services/geminiService.ts`: lógica e validações implementadas no código.
